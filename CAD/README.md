...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 | ⏳ [03 Advanced Computational Design for BIM](https://www.youtube.com/watch?v=g4-TZngbtL8&list=PLAQfn-QKbiAnAHH2_WCO402q-PmQzaTnT) | Autodesk Education | 09 | 30 | | 2017 | Priority, [Dataset](http://dynamobim.org/wp-content/links/AdvancedCurricullum.zip), [Mirror](https://academy.autodesk.com/curriculum/bim-advanced-computational-design) // SetParameter.ByName to flex parametric masses, create lists for many parameters // dscript cond.: if(cond, return_true, return_false) i.e. same as GH // StructuralFraming.BeamByCurve, StructuralType.Beam
