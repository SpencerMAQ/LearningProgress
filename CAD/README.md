...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 ⏳ [Repeat and Divide (Curtain System, Adaptive Components)](https://www.youtube.com/playlist?list=PLGdDXXEHnr4V3bEEJaI7m5EbR6Of7HodQ) | zach kron | 03 | 04 | | | High Quality 10/10, Note to Adaptive Components, When creating offsets then ref lines along the offset Ref Points, also draw them in order!, I can't believe I'm saying this but Revit is way more flexible that SKP despite its reputation as difficult to learn
...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 ✔ [04 Dynamo](https://www.youtube.com/watch?v=QETG7HaaaaI&list=PLY-ggSrSwbZo0vCNJOFhzEQW_nbEfBKo8) | Autodesk Building Solutions | 29 | 29 | | | Priority (Watch after Advanced Revit), Last 10 vids = same as 01, Order: Dynamo Tutorials, Vignette, Medical Center // Dynamo Tutorials - bad 'tutorials' // They basically repeated the same tutorials over and over // Vignette = exactly the same as 01, 3/10
 ...
 ⏳ [Dynamo Primer](http://dynamoprimer.com/en/) | | 06.03 | 13.04 | | 2017 | High Quality // Best Explanation of List.Combine
