...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 ⏳ [Repeat and Divide (Curtain System, Adaptive Components)](https://www.youtube.com/playlist?list=PLGdDXXEHnr4V3bEEJaI7m5EbR6Of7HodQ) | zach kron | 01 | 04 | | | High Quality, Note to Adaptive Components, When creating offsets then ref lines along the offset Ref Points, also draw them in order!
