...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 ⏳ [RevitPythonShell, RevitAPI](http://wiki.theprovingground.org/revit-api#toc3) | Nathan Miller | 06 |14 | | | Python Scripting in revit, [sample scripts](https://github.com/daren-thomas/rps-sample-scripts) // 05: Form Creation // FamilyItemFactory for methods related to RefPlanes, Revolves, Extrusions, (obsoleted)NewDividedSurface -> DividedSurface.Create // 06: Divided Surfaces
