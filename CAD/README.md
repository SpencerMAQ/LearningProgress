...
Title | Author | Progress | Total | Duration | Last Reviewed | Remarks |
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ⏳  [Learn to program the Revit API by Boost Your BIM](https://www.udemy.com/revitapi/) | Udemy | 03.001 | 14.03 | | | Comprehensive, Priority, 7 hrs, C# // TaskDialog.Show // UIDocument = info about how the revit user interacts with the file, involves info about the view windows and selections // ALWAYS USE TRANSACTIONS
