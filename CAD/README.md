...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 ⏳ Paneling With Dynamo for Revit | Lynda | 14 | 27 | 2h51m | 2018 | Good, 8.4/10 // Clockwork, LunchBox, Ampersand, Quads from Rectangular Grid, Spring Nodes // Ch1: 01-08 // 13: Very Good Excercise -- Key Lessons: need to explode solids to get surfaces for `ClosestPointTo` node -- be wary of `shifting` multi-level lists, be sure you operate on the list of the items
