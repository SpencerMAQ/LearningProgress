...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 | ⏳ Massing With Revit | InfiniteSkills/Ed Cotey | 04.01 | 06.01 | | 2017 | 31 Videos, Conceptual Mass // Masses off by default, will not print or export unless on in VG, Mass types - Mass Family (built-in, place mass, primitive), In-place, Conceptual family mass (from family editor, drawn in fam editor then loaded into project), You can do sched fields that are results of calculations // Order of felxibility: library forms, in-place mass, from fam editor // Mass Revolve - profile and axis (axis drawn on ref plane), Sweep (can be two profiles on each end, use point to create perp frame) // blend = composed of 2 or more 2d profiles connected by a common path // surfaces(extruded lines), loft (2 or more profiles)
...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 | [03 Advanced Computational Design for BIM](https://www.youtube.com/watch?v=g4-TZngbtL8&list=PLAQfn-QKbiAnAHH2_WCO402q-PmQzaTnT) | Autodesk Education | 0 | 30 | | | Priority, [Dataset](http://dynamobim.org/wp-content/links/AdvancedCurricullum.zip), [Mirror](https://academy.autodesk.com/curriculum/bim-advanced-computational-design)
