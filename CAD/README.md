...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 Dynamo for Revit Python Scripting | Lynda | 00 | 32 | | | Basic

 ### Revit API
Title | Author | Progress | Total | Duration | Last Reviewed | Remarks |
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ⏳  [Learn to program the Revit API by Boost Your BIM](https://www.udemy.com/revitapi/) | Udemy | 11.001 | 14.003 | | | Comprehensive, Priority, 7 hrs, C# // TaskDialog.Show // UIDocument = info about how the revit user interacts with the file, involves info about the view windows and selections // ALWAYS USE TRANSACTIONS // f.Symbols not working // skipped: 06.005: Extensible Storage, skipped: 06.007 Dynamic Model Update: e.g. user adds text, macro detects it isn't part of standards, deletes it // 07: not reviewed that much // 08: Doesn't contain anything // 10: paid
