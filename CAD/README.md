...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 | ⏳ [03 Advanced Computational Design for BIM](https://www.youtube.com/watch?v=g4-TZngbtL8&list=PLAQfn-QKbiAnAHH2_WCO402q-PmQzaTnT) | Autodesk Education | 04 | 30 | | | Priority, [Dataset](http://dynamobim.org/wp-content/links/AdvancedCurricullum.zip), [Mirror](https://academy.autodesk.com/curriculum/bim-advanced-computational-design) // SetParameter.ByName to flex parametric masses
