...
:-- | :-- | :-- | :-- | :-- | :-- | :--
 ...
 | ✔ Creating a Wood Frame Model in Revit | Digital Tutors | 11 | 11 | | 2017 | Timber Structural Framing, Summary: Sill - Beam, Studs - Columns, use actual size not nominal, C. Joist = offset due to rafters, 50% of the time = copying. Coping not covered, Truss not covered
